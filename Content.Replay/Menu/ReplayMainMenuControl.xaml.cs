...
{
    public ReplayMainMenuControl(IResourceCache resCache, TypographyManager typographyManager)
    {
        ...
        Subtext.FontOverride = typographyManager.GetFont(FontType.SansSerif, TextStyle.Title1, FontWeight.Bold);
