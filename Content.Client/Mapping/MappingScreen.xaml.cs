...
public sealed partial class MappingScreen : InGameScreen
{
    ...
    public MappingScreen()
    {
        ...
        Pick.Icon         = SymbolIcons.Colorize;
        PickDecal.Icon    = SymbolIcons.WandShine;
        Flip.Icon         = SymbolIcons.RotateRight;
        Visibility.Icon   = SymbolIcons.Stacks;
        FixGridAtmos.Icon = SymbolIcons.Spo2;
        RemoveGrid.Icon   = SymbolIcons.Remove;
        MoveGrid.Icon     = SymbolIcons.OpenWith;
        GridVV.Icon       = SymbolIcons.DataObject;
        PipesColor.Icon   = SymbolIcons.FormatPaint;
        ChatButton.Icon   = SymbolIcons.Chat;
    ...
    private void FlipSides()
    {
        ...
        if (SpawnContainer.GetPositionInParent() == 0)
            ...
            Flip.Icon = SymbolIcons.RotateLeft;
    }
