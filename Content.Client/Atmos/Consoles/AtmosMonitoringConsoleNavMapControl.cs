...
public sealed partial class AtmosMonitoringConsoleNavMapControl : NavMapControl
{
    ...
    private readonly float[] _layerFraction = [0.0f, 0.25f, 0.5f, 0.75f, 1.0f,];
