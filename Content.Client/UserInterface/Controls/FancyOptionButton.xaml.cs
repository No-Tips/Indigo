...
public sealed partial class FancyOptionButton : ContainerButton
{
    ...
    public void Select(int idx)
    {
        ...
        SelectedIdx            = idx;
        SelectedItemLabel.Text = item.Text;
    ...
    private void TogglePopup()
    {
        ...
        else
        {
            ...
            {
                var topLeft = SelectedItemLabel.GlobalRect.TopLeft;
    ...
    {
        public Label SelectedMarkLabel { get; }
        ...
        public ItemButton(string title)
        {
            ...
            SelectedMarkLabel = new()
            {
                ...
                StyleClasses        = { UIStyleClasses.LabelIconFilledSemiBold3, }
            };
