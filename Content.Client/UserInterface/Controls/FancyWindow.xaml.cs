...
public partial class FancyWindow : BaseWindow
{
    ...
    public FancyWindow()
    {
        ...
        HelpButton.Icon           =  SymbolIcons.Circle;
        HelpButton.OnMouseEntered += static ev => ((FancyButton) ev.SourceControl).Icon = SymbolIcons.Cancel;
        HelpButton.OnMouseExited  += static ev => ((FancyButton) ev.SourceControl).Icon = SymbolIcons.Help;
