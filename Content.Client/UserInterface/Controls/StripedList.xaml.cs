...
public sealed partial class StripedList : BoxContainer
{
    ...
    public void AddControl(Control control)
    {
        var panel = new PanelContainer
        {
            PanelOverride = new StyleBoxFlat
                { BackgroundColor = Colors[ContentContainer.Children.Count(c => c.Visible) % Colors.Count], },
