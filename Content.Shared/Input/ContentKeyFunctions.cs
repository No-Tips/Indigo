...
public static class ContentKeyFunctions
{
    ...
    public static readonly BoundKeyFunction GhostBar           = "GhostBar";
    public static readonly BoundKeyFunction GhostReturnToBody  = "GhostReturnToBody";
    public static readonly BoundKeyFunction GhostReturnToRound = "GhostReturnToRound";
    public static readonly BoundKeyFunction GhostRoles         = "GhostRoles";
    public static readonly BoundKeyFunction GhostWarp          = "GhostWarp";
